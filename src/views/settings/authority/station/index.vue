        ...
        platformTable: new Table({
          ...
          columns: {
            name1: {
              ...
              // ":active-value": 0,
              // ":inactive-value": 1,
              // "@change": (val, item, arr, index) => {
              //   console.log(val, item);
              //   item.username = val == "1" ? "123" : "321";
              // }
              // sortKey: "o_name",
          ...
          // select: [
          //   { key: "s_name", title: "姓名" },
          //   { key: "s_username", title: "登录名" },
          //   { key: "s_username,s_name", title: "登录名或姓名" }
          // ]
          // }
